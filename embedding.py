...
def pre_train_embedding(embed_type, pre_embed_model, train, test):
    ...
    if embed_type == "CounterVector":
        ...
        count_vectorizer = load(
            open("/home/ubuntu/DIMosaic/embedding_model/" + pre_embed_model, "rb"))
        ...
        doc_vectorizer = Doc2Vec.load(
            '/home/ubuntu/DIMosaic/embedding_model/' + pre_embed_model)
...
def embedding(filename, embed_type, train, test, embed_params):
    ...
    if embed_type == "CounterVector":
        ...
        dump(count_vectorizer,
             open("/home/ubuntu/DIMosaic/embedding_model/" + filename + "_counterVec.pkl", "wb"))
        ...
        dump(tfidf_vectorizer,
             open("/home/ubuntu/DIMosaic/embedding_model/" + filename + "_tfidf.pkl", "wb"))
        ...
        doc_vectorizer.save(
            '/home/ubuntu/DIMosaic/embedding_model/' + filename + '_doc2vec.pkl')
