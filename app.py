...
print(os.getcwd())
train_file_path = '/home/ubuntu/DIMosaic/train_list/'
test_file_path = '/home/ubuntu/DIMosaic/test_list/'
embed_model_path = '/home/ubuntu/DIMosaic/embedding_model/'
machine_model_path = '/home/ubuntu/DIMosaic/machine_model/'
path = '/home/ubuntu/DIMosaic/csv_files/'
...
def page4():
    if os.path.isfile('/home/ubuntu/DIMosaic/csv_files/metrics_score_train.csv'):
        return render_template('visualization.html', visualization="embedding_and_machineLearning_visualization")
    else:
        return render_template('visualization.html', visualization="embedding_and_visualization")
