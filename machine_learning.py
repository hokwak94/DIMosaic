...
def pre_train_machine_learning(embedding_model_name, machine_type, X_train, X_test, y_train, y_test):
    ...
    if machine_type == 'Logistic':
        ...
        filename = '/home/ubuntu/DIMosaic/machine_model/' + embedding_model_name.lower() + '_logistic.pkl'
        ...
        # load the machine_model from disk
        filename = '/home/ubuntu/DIMosaic/machine_model/' + embedding_model_name.lower() + '_svm.pkl'
        ...
        # load the machine_model from disk
        filename = '/home/ubuntu/DIMosaic/machine_model/' + embedding_model_name.lower() + '_randomforest.pkl'
        ...
        fnn_clf = tf.keras.models.load_model(
            '/home/ubuntu/DIMosaic/machine_model/' + embedding_model_name.lower() + '_fnn.h5')
